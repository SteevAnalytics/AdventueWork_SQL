...
--Task 9: Calculate Total Sales Amount for Each Year from 2012 to 2014
...
SELECT P.ProductID, P.Name, P.ProductNumber, P.ListPrice, SOD.SalesOrderID, SOD.SalesOrderDetailID
...
--Task 15: Display All Products Sold More Than 50 Times in 2014
